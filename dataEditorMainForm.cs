...
namespace dataEditor
{
    public partial class MainForm : Form
    {
        ...
        private void toolBtnConvertFile_ButtonClick(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < mgDataViewer.RowCount; i++)
            {
                ...
                if (mgDataViewer.Rows[i].Cells[0].Value != DBNull.Value && result)
                {
                    ...
                    if (mgDataViewer.Rows[i].Cells[7].Value.ToString() == "A+, кВт*ч" && mgDataViewer.Rows[i + 1].Cells[7].Value.ToString() == "A-, кВт*ч")
                    {
                    ...
                    else
                    {
                        ...
                        {
                            if (BigCycle < mgDataViewer.Rows.Count && mgDataViewer.Rows[BigCycle].Cells[7].Value.ToString() == "A-, кВт*ч")
                            {
                                ...
                                {
                                    if (mgDataViewer.Rows[SmallCycle].Cells[8].Value.ToString() == "Сумма")
                                    {
        ...
        private void mgDataСalculation_Click(object sender, EventArgs e)
        {
            ...
            if (mgDataViewer.Rows[mgDataViewer.CurrentCell.RowIndex].Cells["dataTable"].GetType().Name == "DataGridViewButtonCell")
            {
                ...
                if (parentNode != null)
                {
                    if (mgDataViewer.Rows[mgDataViewer.CurrentCell.RowIndex].Cells["dataTable"].ToolTipText.Contains('+'))
                    {
                        ...
                        parentNode.Nodes[0].ImageIndex = 1;
                        parentNode.Nodes[0].SelectedImageIndex = 1;
                        parentNode.Nodes.Add(mgDataViewer.Rows[mgDataViewer.CurrentCell.RowIndex].Cells["dataTable"].ToolTipText.Split("+").Last());
                        parentNode.Nodes[1].ImageIndex = 1;
                        parentNode.Nodes[1].SelectedImageIndex = 1;
